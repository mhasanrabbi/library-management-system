            ...
            <div class="col">
                <form action="{{ route('manage.books.update', $book->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Enter Book Title" name="title" value="{{ $book->title}}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="image" placeholder="Add Image" name="image" value="{{ $book->image}}">
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="total_books" placeholder="Total Books" name="total_books" value="{{ $book->total_books}}">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="book_source_id" class="form-label">Book Source</label>
                                <input type="text" class="form-control" id="book_source_id" placeholder="Book Source" name="book_source_id" value="{{ $book->book_source}}">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <label for="rack" class="form-label">Rack Number</label>
                                <input type="text" class="form-control" id="rack" placeholder="Rack Number" name="rack" value="{{ $book->rack_no}}">
                            </div>
                        </div>
                        {{-- <div class="col-6 mb-3">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="customRadioInline1" name="available" class="custom-control-input">
                                <label class="custom-control-label" for="available">Available</label>
                              </div>
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="customRadioInline2" name="not_available" class="custom-control-input">
